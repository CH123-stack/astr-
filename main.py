    ...
    def _format_source_name(source_key: str) -> str:
        ...
        source_names = {
            "fan_studio": {
                ...
                "usgs_earthquake": "美国地质调查局（USGS）地震测定",
                "europe_emsc_earthquake": "欧洲地中海地震中心（EMSC）地震测定",
                "china_weather_alarm": "中国气象局气象预警",
                "china_tsunami": "自然资源部海啸预警",
                "usa_shakealert_eew": "美国 ShakeAlert 地震预警",
                "korea_kma_eew": "韩国气象厅地震预警",
                "fssn_earthquake": "FSSN 地震信息",
            },
            "p2p_earthquake": {
